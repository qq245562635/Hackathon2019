...
namespace ProductRecommender
{
    class Program
    {
        ...
        private static string BaseDataSetRelativePath = Path.Combine(Environment.CurrentDirectory,"Data");
        ...
        //var TrainingDataRelativePath = Path.Combine(Environment.CurrentDirectory, "Data", "recommendation-ratings-train.csv");
